package com.myweb.lab7dialogrv_sec1_603020800_2
...
class MainActivity : AppCompatActivity() {
    ...
    fun addStudent(v: View){
        ...
        mDialogView.btnAdd.setOnClickListener{
            ...
            Toast.makeText(applicationContext, "The student is added successfilly", Toast.LENGTH_SHORT).show()
    ...
    fun testStudentData(){
        studentList.add(Student("603020800-2", "Student 1", 20))
        studentList.add(Student("603020800-2", "Student 2", 21))
    }
}
